...
def play_time():
	...
	song = f'/Users/jerryc.quiles/Desktop/player/audio/03{song}.mp3'
	...
	if int(song_slider.get()) == int(song_length):
		...
		# Convert Slider position to time formart
...
def add_song():
	...
	song = song.replace("/Users/jerryc.quiles/Desktop/player/audio/12", "")
	song = song.replace("/Users/jerryc.quiles/Desktop/player/audio/08", "")
	song = song.replace("/Users/jerryc.quiles/Desktop/player/audio/06", "")
	song = song.replace("/Users/jerryc.quiles/Desktop/player/audio/03", "")
...
def delete_song():
	# delete Highlighter Song From Playlist
	playlist_box.delete(ANCHOR)

# Create Function To Delete All Songs Frrom Playlist
...
def play():
	# Set Stopped To Fale since a song is now playing
	global stopped
	stopped = False
...
def previous_song():
	...
	#Get current song number
	next_one = playlist_box.curselection()
	# Subrtract One To the Current Song Number Tuple
	next_one = next_one[0] - 1
...
# Create a Slide Function For Song Poisiton
def slide(x):
	# Reconstruct song with directory structure stuff
	song = playlist_box.get(ACTIVE)
	song = f'/Users/jerryc.quiles/Desktop/player/audio/03{song}.mp3'             
...
# Create Song Slider
song_slider = ttk.Scale(main_frame, from_=0, to=100, orient=HORIZONTAL, length=450, value=0, command=slide) 
...
back_button = Button(control_frame, image=back_btn_img, highlightbackground="#ffffff", command=previous_song)
forward_button = Button(control_frame, image=forward_btn_img, highlightbackground="#ffffff", command=next_song)
play_button = Button(control_frame, image=play_btn_img, highlightbackground="#ffffff", command=play)
pause_button = Button(control_frame, image=pause_btn_img, highlightbackground="#ffffff", command=lambda: pause(paused))
stop_button = Button(control_frame, image=stop_btn_img, highlightbackground="#ffffff", command=stop)
